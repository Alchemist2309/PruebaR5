...
class TestBuyValid(unittest.TestCase):
    ...
    def test_01(self):
        ...
        self.driver.find_element_by_xpath("//input[@id='mat-input-3']").send_keys("carrera 31 #51-60")
        self.driver.find_element_by_xpath("//input[@id='mat-input-4']").clear()
        self.driver.find_element_by_xpath("//input[@id='mat-input-4']").send_keys("bipefi12@gmail.com")
        self.driver.find_element_by_xpath("//input[@id='mat-input-5']").clear()
        self.driver.find_element_by_xpath("//input[@id='mat-input-5']").send_keys("3208036321")
        ...
        self.driver.save_screenshot("test_buy_soat_valid02.png")
